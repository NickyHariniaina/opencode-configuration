...
- Use this commit message template: `<type>(<scope>): <subject>`
- Ask clarifying questions about the <type> you're supposed to use.
- Better use commitizen and ask the questions about the commit message to the user
